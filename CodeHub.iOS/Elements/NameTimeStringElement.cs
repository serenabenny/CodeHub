...
//                context.RestoreState ();
            ...
            nsName.DrawString(new CGRect(leftMargin, TopBottomPadding, contentWidth, _userFont.LineHeight),
            ...
            var nsTime = new NSString(Time);
            nsTime.DrawString(timeRect, _dateFont, UILineBreakMode.TailTruncation);
            ...
            if (!string.IsNullOrEmpty(String))
            {
                ...
                var nsString = new NSString(String);
                nsString.DrawString(stringRect, _descFont, UILineBreakMode.TailTruncation);
            }
        }

        public override nfloat Height(UITableView tableView, CGRect bounds)
        {
