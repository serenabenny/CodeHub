...
namespace CodeFramework.iOS.Views
{
    public class TableViewSectionView : UIView
    {
        ...
        public static CoreGraphics.CGGradient BottomGradient;
        public static CoreGraphics.CGGradient TopGradient;
        
        static TableViewSectionView ()
        {
            using (var rgb = CoreGraphics.CGColorSpace.CreateDeviceRGB()){
                nfloat [] colorsBottom = {
                    1, 1, 1, 0f,
                    0.4f, 0.4f, 0.4f, .6f
                };
